...

{
    ...
    /// </summary>
    /// <param name="other">The object to compare with the current <see cref="Highscore"/>.</param>
    ...
    public bool Equals(Highscore other)
    {
        return mapName == other.mapName &&
               ...
               looserName == other.looserName &&
               winnerScore == other.winnerScore &&
               loserScore == other.loserScore &&
               agentWinner == other.agentWinner &&
               agentLoser == other.agentLoser;
    }
    ...
    public override int GetHashCode()
    {
        ...
        hashCode = hashCode * 23 + looserName.GetHashCode();
